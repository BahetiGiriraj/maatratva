    ...
    <main className="min-h-screen bg-[#FAF7F4] pt-28">
      <section className="section-padding">
        <div className="container-wide">
          <Link
            href="/programs"
            className="mb-10 inline-flex items-center gap-2 font-body text-sm font-semibold text-[#642244]"
          >
            <ArrowLeft size={16} />
            Back to Programs
          </Link>
          ...
          <div className="mx-auto mb-14 max-w-3xl text-center">
            <p className="mb-3 font-body text-sm font-semibold uppercase tracking-[0.18em] text-[#642244]">
              Our Community
            </p>
            <h1 className="font-display text-5xl font-semibold leading-tight text-[#4B3B3B] md:text-6xl">
              Moments From Our{" "}
              <span className="text-[#642244]">Workshops</span>
            </h1>
