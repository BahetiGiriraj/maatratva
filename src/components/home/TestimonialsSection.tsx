...
const allReviews = [
  { name: "Shilpi Kashyap", location: "Indore, India", text: "Ever since I took Dheera ma'am's first seminar, I got the positive vibes. I started Garbh Sanskar classes and my perspective suddenly changed. Everyone including my husband started telling me that my nature has changed positively. I feel empowered to manage my mental well-being." },
  { name: "Aayushi Jain", location: "Indore, India", text: "Every chat with Dheera ma'am was so relaxing that I used to forget about anxiety. The lessons on gratitude, forgiveness and love made me kinder. Her caring, smiling nature gives me a motherly feeling. I loved the meditation and Tratak kriya sessions." },
  ...
  { name: "Purvi Neema", location: "Mumbai, India", text: "My final months of pregnancy were the best and blessed months after I found Dheera ma'am. I was calm and happy during my labour and had only love and positivity — only because of her. She is the best mentor I can ever get." },
  ...
  { name: "Nisha Patwari", location: "Indore, India", text: "Dhira ma'am's sessions are extremely beneficial for natural delivery. I found the meditation classes very helpful in connecting with my baby. Thank you for educating me on this beautiful journey." },
