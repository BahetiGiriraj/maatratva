...
const content = {
  privacy: {
    ...
    sections: [
      ...
      { title: "Your Rights", body: "You have the right to access, update, correct or delete your personal information at any time. To exercise these rights, contact us at +91 88151 82545." },
      { title: "Contact Us", body: "Questions about this Privacy Policy? Reach us at Maatratva.wonder@gmail.com or +91 88151 82545. We respond within 5 business days." },
    ],
  },
  terms: {
    ...
    sections: [
      ...
      { title: "Intellectual Property & Trademark", body: "All content, materials, programs, recordings and methodologies provided by Maatratva are our intellectual property and protected by applicable laws. Reproduction or distribution without written permission is prohibited. Maatratva™ is a registered trademark. The name, logo, and brand identity of Maatratva are exclusively owned by us and may not be used, copied, or imitated in any form without prior written consent." },
      ...
      { title: "Contact", body: "For questions about these Terms, contact us at Maatratva.wonder@gmail.com or +91 88151 82545." },
    ],
  },
};
